      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
          ...
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            <span className="text-[14px] sm:text-[15px] font-medium text-[#65758B]">Pending Reviews</span>
            ...
            <p className="text-[14px] text-[#A66A00] mt-0.5">Awaiting evaluation</p>
          </div>
          ...
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            ...
            <p className="text-[14px] text-[#287A55] mt-0.5">Validated activities</p>
          </div>
          ...
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            ...
            <p className="text-[14px] text-[#B33A3A] mt-0.5">Returned with remarks</p>
          </div>

          {/* Card 4: Total Submissions */}
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            <span className="text-[14px] sm:text-[15px] font-medium text-[#65758B]">Total Submissions</span>
        ...
        <div className="bg-white rounded-[6px] border border-[#D9E0E7] overflow-hidden">
          <div className="px-4 py-3 border-b border-[#D9E0E7] flex items-center justify-between bg-[#F5F7F9]">
            <div>
              <h2 className="text-[21px] sm:text-[22px] font-semibold text-[#0B2945]">Pending Submissions</h2>
              <p className="text-[14px] text-[#65758B]">Student submissions awaiting faculty verification and review</p>
            </div>
            <span className="text-[14px] font-semibold px-2 py-0.5 bg-[#FEF7EB] text-[#A66A00] border border-[#F6DFC0] rounded-[4px]">
          ...
          {pendingSubmissions.length > 0 ? (
            ...
            <div className="py-12 text-center text-[#65758B] text-[14px]">
              ...
              <p className="text-[#65758B] mt-0.5 text-[14px]">All student activities have been evaluated.</p>
            </div>
          )}
        </div>
      </div>
