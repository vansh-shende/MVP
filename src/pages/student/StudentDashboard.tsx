    ...
    <DashboardLayout>
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-[6px] border border-[#D9E0E7] px-5 py-3.5">
          ...
          <p className="text-[14px] sm:text-[15px] text-[#65758B] mt-0.5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
          ...
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            <span className="text-[14px] sm:text-[15px] font-medium text-[#65758B]">Total Activities</span>
            <p className="text-[28px] sm:text-[30px] font-bold text-[#0B2945] font-mono mt-0.5">
              {stats.studentStats.totalActivities < 10
                ? `0${stats.studentStats.totalActivities}`
                : stats.studentStats.totalActivities}
            </p>
            <p className="text-[14px] text-[#65758B] mt-0.5">Submitted records</p>
          </div>

          {/* Pending */}
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            <span className="text-[14px] sm:text-[15px] font-medium text-[#65758B]">Pending</span>
            <p className="text-[28px] sm:text-[30px] font-bold text-[#A66A00] font-mono mt-0.5">
              {stats.studentStats.pending < 10
                ? `0${stats.studentStats.pending}`
                : stats.studentStats.pending}
            </p>
            <p className="text-[14px] text-[#A66A00] mt-0.5">Awaiting faculty review</p>
          </div>

          {/* Approved */}
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            <span className="text-[14px] sm:text-[15px] font-medium text-[#65758B]">Approved</span>
            <p className="text-[28px] sm:text-[30px] font-bold text-[#287A55] font-mono mt-0.5">
              {stats.studentStats.approved < 10
                ? `0${stats.studentStats.approved}`
                : stats.studentStats.approved}
            </p>
            <p className="text-[14px] text-[#287A55] mt-0.5">Verified records</p>
          </div>

          {/* Rejected */}
          <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-3.5">
            <span className="text-[14px] sm:text-[15px] font-medium text-[#65758B]">Rejected</span>
            <p className="text-[28px] sm:text-[30px] font-bold text-[#B33A3A] font-mono mt-0.5">
              {stats.studentStats.rejected < 10
                ? `0${stats.studentStats.rejected}`
                : stats.studentStats.rejected}
            </p>
            <p className="text-[14px] text-[#B33A3A] mt-0.5">Requires correction</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
          ...
          <div className="lg:col-span-8 bg-white rounded-[6px] border border-[#D9E0E7] overflow-hidden">
            <div className="px-4 py-3 border-b border-[#D9E0E7] flex items-center justify-between bg-[#F5F7F9]">
              <div>
                <h2 className="text-[21px] sm:text-[22px] font-semibold text-[#0B2945]">Recent Submissions</h2>
                <p className="text-[14px] text-[#65758B]">Latest submissions</p>
              </div>
              <button
                onClick={() => navigate('/student/submissions')}
                className="text-[15px] font-semibold text-[#123B63] hover:text-[#0B2945] transition-colors inline-flex items-center gap-1"
              >
                View All
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-[15px]">
                <thead>
                  <tr className="bg-white border-b border-[#D9E0E7] text-[#65758B] font-semibold text-[14px]">
                ...
                <tbody className="divide-y divide-[#D9E0E7]">
                  {recentSubmissions.map((sub) => (
                    ...
                    >
                      ...
                      {/* Date */}
                      <td className="py-3 px-4 text-[#65758B] whitespace-nowrap font-mono text-[14px]">
                  ...
                  {recentSubmissions.length === 0 && (
                    <tr>
                      <td colSpan={4} className="py-8 text-center text-[#65758B] text-[15px]">
            ...
            <div className="bg-white rounded-[6px] border border-[#D9E0E7] p-4">
              <div className="flex items-center justify-between pb-2.5 border-b border-[#D9E0E7] mb-3">
                <div className="flex items-center gap-2">
                  <User className="w-4 h-4 text-[#65758B]" />
                ...
                <button
                  ...
                  className="text-[15px] font-semibold text-[#123B63] hover:text-[#0B2945]"
                >
                  View Details
                </button>
              </div>
              ...
              <div>
                <h4 className="font-bold text-[#0B2945] text-[18px]">
                  {currentUser?.name || 'Vansh Shende'}
                </h4>
                <p className="text-[14px] sm:text-[15px] text-[#65758B]">
                  {currentUser?.department || 'Information Technology'}
                </p>
              </div>

              <div className="space-y-1.5 text-[14px] sm:text-[15px] border-t border-[#D9E0E7] mt-3 pt-2.5">
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[15px] font-semibold">Add New Activity</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[15px] font-semibold text-[#0B2945]">My Submissions</span>
                  </div>
